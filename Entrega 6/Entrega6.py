...
for N in list1:
    ...
    for i in range(Ncorridas):
        ...
        #metodo1    
        A = matriz_laplaciana_llena(N) #matriz A
        ...
        b3 = np.ones(N)
        t5 = perf_counter()
        X3 = linalg.solve(A2,b2,assume_a="sym")
        t6 = perf_counter()
        dt3 = t6-t5
        dts[i][2] = dt3
        #metodo4
        ...
        b4 = np.ones(N)
        t7 = perf_counter()
        X4 = linalg.solve(A2,b2,assume_a="sym")
        t8 = perf_counter()
        dt4 = t8-t7
        dts[i][3] = dt4
        #metodo5
        ...
        b5 = np.ones(N)
        t9 = perf_counter()
        X5 = linalg.solve(A2,b2,assume_a="pos")
        t10 = perf_counter()
        dt5 = t10-t9
        dts[i][4] = dt5
        #metodo6
        ...
        b6 = np.ones(N)
        t11 = perf_counter()
        X6 = linalg.solve(A2,b2,assume_a="pos",overwrite_a=True,overwrite_b=True)
        t12 = perf_counter()
        dt6 = t12-t11
        dts[i][5] = dt6
